...
//	$result = mysql_query("SELECT camp0, nombre, i1, i2, i3, i4, pase FROM cantantes WHERE estilo = '$estilo' AND i1 = '0' AND pase = '0' order by  camp0 limit 0, 88", $dbh);
	...
	while ($row = mysql_fetch_row($result)){
        ...
        <tr>
		  ...
		  <a href="artista1.php?id=<?php echo $rowx[0]; ?>"> <? echo $rowx[1]; ?> </a>
		  <? //echo $rowx[0]; print "SELECT camp0, nombre, i1, i2, i3, i4 FROM cantantes WHERE i2 = '$var2' AND i3 = '0' order by camp0 limit 0, 88";?> &nbsp;</span></td>
          <?
									// sub sub categorias
									$var2 = $rowx[0];
									$resulty = mysql_query("SELECT camp0, nombre, i1, i2, i3, i4 FROM cantantes WHERE i2 = '$var2' AND i3 = '0' order by camp0 limit 0, 88", $dbh);
        ...
        <tr>
          ...
          <td><span class="Estilo2">&nbsp;
		  									<a href="artista1.php?id=<?php echo $rowy[0]; ?>">
		  									<? echo $rowy[1]; 
											$varex = $rowy[0];
											?></a> &nbsp;</span></td>
          <?
