        ...
        <tr>
          <td>
              <table width="400" border="0" cellpadding="0" cellspacing="2">
                ...
                <tr>
                  <td><span class="Estilo7">Actividad </span></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td><hr /></td>
                ...
                <tr>
                  <td><table width="500" border="0">
                    <tr>
                      <?
$result = mysql_query("SELECT camp0, idcant, nombre, descripcion, estilo, decada, precio, foto, precio1, fecha FROM tienda WHERE idcant = '$id' AND fecha = '$fecadmin' order by camp0 DESC limit 0,15", $dbh);
...
?>
	...
	while($row = mysql_fetch_array($result))
	{
		...
		?>
                    <tr>
                      <td width="160"><?php	echo $row["fecha"]; ?>
					  </td>
	...
	$result = mysql_query("SELECT camp0, nombre, i1, i2, i3, i4 FROM cantantes WHERE estilo = '$varestilo' AND i1 = '$id'  order by  camp0 limit 0, 88", $dbh);
		...
		?>				  </td>
          ...
          <td valign="top"><table width="400" border="0" cellpadding="4" cellspacing="0">
              <tr>
                <td>QUIENES LO VIGILAN quienes ponen sus actividades </td>
              </tr>
              <tr>
                <td>
				...
				<a href="#">yo tambien quiero vigilarlo</a>				</span>				</td>
              </tr>
              <tr>
      ...
      <form id="form1" name="karta" method="get" action="artista1con2.php" enctype="multipart/form-data">
