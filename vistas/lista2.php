...
.Estilo7 {font-size: 24px; color: #333333; }
-->
</style>
</head>
...
<div class="cuerpoc">
  ...
  <table width="800" border="0" cellspacing="0" cellpadding="3">
    <tr>
      <td colspan="5" align="center"><span class="Estilo7">B&uacute;squeda de Autoridades </span></td>
      </tr>
    <tr>
      <td width="270">&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td bgcolor="#999999">&nbsp;</td>
      <td><span class="Estilo5">Protecci&oacute;n al consumidor </span></td>
    </tr>
    <tr>
            ...
            <td>&nbsp;</td>
				...
				<table>
				  <tr>
					...
					<td>
						&nbsp;
						<a href="lista1.php?estilo=<?php echo $row2["nombre"]; ?>"><span class="Estilofont1">
				  		<font size="4"><?php	echo $row2["nombre"]; ?></font>
						</span></a>					</td>
			  	   	</tr>
			  	</table>				</td>
			  </tr>
