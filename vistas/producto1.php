...
<div class="cuerpoc">
  ...
  <table width="800" border="0" cellpadding="0" cellspacing="2" bgcolor="#E9E9E9">
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td><table width="800" border="0" cellpadding="3" cellspacing="0">
        <tr>
          ...
          <td valign="top"><table width="500" border="0" align="center" cellpadding="1" cellspacing="0">
            <tr>
            ...
            <tr>
              <td>Ver respuesta  de la autoridad  </td>
              <td>
      ...
      <td>&nbsp;</td>
		...
		if ($idus!="")
		{
			if ($flag!="")
			{
				...
				if($resultado !== FALSE){
					echo "La cadena no valida fue encontrada";
					exit();
				}
				$buscar = "<A";
				$resultado = strpos($cadena, $buscar);
				...
				$pregunta1 = strip_tags($pregunta);  //le quita las etiquetas html
...
$result = mysql_query("SELECT camp0, idprod, idautorori, nomautorori, preg, fecha FROM preguntas WHERE idprod = '$id' order by camp0 DESC limit 0,15", $dbh);
	...
	?>
        <tr>
          ...
          <td>Opinion de:&nbsp; <?php //echo $row["idautorori"]; ?> <a href="perfil1.php?id=<? echo $row["idautorori"];?>" target="_blank"> <?php echo $row["nomautorori"]; ?></a> </td>
          <td>.</td>
        </tr>
        <?php
	}
