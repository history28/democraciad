  ...
  <table width="800" border="0" cellspacing="0" cellpadding="3">
    <tr>
	  ...
	  <table width="600" border="1" cellpadding="2" cellspacing="0" bordercolor="#999999">
        ...
        <?
	$cuenta = 0;
	$result = mysql_query("SELECT camp0, nombre, region, partido, i1, i2, i3, i4 FROM cantantes WHERE estilo = '$estilo' AND i1 = '0'  order by region, partido, nombre limit 0, 88", $dbh);
	while ($row = mysql_fetch_row($result)){
        ...
        <tr>
		  ...
		  <a href="artista1con.php?id=<?php echo $row[0]; ?>">
          ...
          <td align="left"><a href="artista1.php?id=<?php echo $row[0]; ?>">ver</a></td>
        </tr>
          <?
			}
			?>
      ...
      <form id="karta1" name="karta" method="get" action="artista1con4.php" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="fecadmin" id="f_date2" class="box-form" value="<? echo $fecha1; ?>"/>
				      <button id="f_btn2">
					  .
					  <img src="img/calendario-icono.png" width="48" height="48" />Ver calendario <br />de actividades</button>
				      <br />
