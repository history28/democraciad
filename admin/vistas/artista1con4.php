              ...
              <table width="600" border="0" cellpadding="0" cellspacing="2">
                ...
                <tr>
                  <td><table width="600" border="0">
                    <tr>
                      <?
$result = mysql_query("SELECT camp0, idcant, nombre, descripcion, estilo, decada, precio, foto, precio1, fecha, fechan, album FROM tiendacong WHERE fecha = '$fecadmin' order by fechan DESC limit 0,15", $dbh);
...
?>
	...
	while($row = mysql_fetch_array($result))
	{
		...
		?>
                    <tr>
                      <td width="120"><?php	echo $row["fecha"]; ?>					  </td>
